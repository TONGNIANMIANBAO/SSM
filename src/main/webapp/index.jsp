...
<body>
				...
				<div class="modal-body">
					<form class="form-horizontal" id="empSaveForm">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<label class="radio-inline"> <input type="radio" name="gender" id="genderRadio1" value="1" checked="checked" /> 男
								</label> <label class="radio-inline"> <input type="radio" name="gender" id="genderRadio2" value="0" /> 女
								</label>
							</div>
						</div>
						<div class="form-group">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-2">
				<a href="/SSMproject/logout">logout</a>
			</div>
		</div>
